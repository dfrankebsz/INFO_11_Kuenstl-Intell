...
export const usersStore = () => getStore({ name: 'neuroquest-users-v1', region: REGION, consistency: 'strong' });
export const progressStore = () => getStore({ name: 'neuroquest-progress-v1', region: REGION, consistency: 'strong' });
export const sessionsStore = () => getStore({ name: 'neuroquest-sessions-v1', region: REGION, consistency: 'strong' });
